...
\begin{figure}[hbt!]
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption[Správna rotácia]{Správna rotácia modulu.}
    \end{subfigure}
    \begin{subfigure}[b]{0.47\textwidth}
        \includegraphics[width=\textwidth]{pictures/rotation_example_wrong.png}
        \caption[Nesprávna rotácia]{Nesprávna rotácia modulu.}
    \end{subfigure}
...
\begin{figure}[hbt!]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=0.47\textwidth]{pictures/reconnection_example.png}
