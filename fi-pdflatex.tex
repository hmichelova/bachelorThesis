...
Každý modul v spojitom RoFIbote, ktorý sa má rekonfigurovať, dostane na vstup svoj aktuálny (počiatočný) stav a zároveň aj svoj koncový stav. 

Predpokladá sa, že údaje, ktoré dostanú moduly sú validné. To znamená, že údaje sú z popísaných rozsahov a množín. Každá hrana je definovaná pre oba prepojené moduly a to v rovnakom tvare. Zároveň, že konfigurácia RoFIbota, ktoré popisujú dané stavy modulov je spojitá a validná. Toto platí ako pre počiatočné aj pre koncové stavy. 
...
\begin{itemize}
    ...
    \item všetky definované prepojenia je možné vytvoriť, 
    \item nesmie dochádzať k žiadne fyzickej kolízii modulov. 
\end{itemize}
...
V prípade, že RoFIbot sa nedokáže rekonfigurovať z počiatočnej konfigurácie do koncovej, tak algoritmy túto skutočnosť dokážu identifikovať. 
...
\begin{itemize}
    ...
    \item \textit{joint} -- identifikácia stupeňa voľnosti; $joint \in \{\alpha, \beta, \gamma\}$, 
...
\begin{itemize}
    \item \textit{add} -- príznak, či ide o prepojenie alebo rozpojenie,
...
\begin{itemize}
    \item akcia rotácie: nesmie dôjsť ku kolízii s inými modulmi (viď obrázok \ref{fig:rotationsExample}), 
...
// TODO: obrazok rotacie, kde nastane kolizia a kde nie

\begin{figure}[hbt!]
    \centering
    \begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[width=\textwidth]{pictures/reconnection_example.png}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption[Správne spojenie]{Správne spojenie modulov.}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{pictures/reconnection_example_wrong.png}
        \caption[Nesprávne prepojenie]{Nesprávne spojenie modulov.}
    \end{subfigure}
    \caption[Príklad akcie prepojenia]{Príklad akcie prepojenia.}
    \label{fig:reconnectionExample}
\end{figure}

Rekonfigurácia RoFIbota zložená z krokov. \textit{Krok rekonfigurácie} je definovaný ako množina validných akcií. Zároveň pre ne musí platiť že, ak je konfigurácia pred krokom spojitá a validna tak aj počas vykonávania kroku a po jeho vykonaní musí byť konfigurácia spojitá a validna. 

--poznamky

povolene akcie na zmeny; komunikacia podla sprav
